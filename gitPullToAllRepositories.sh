...
for proyecto in */; do
    ...
    if [ -d .git ]; then
        ...
        if ! echo "$GIT_STATUS" | grep -Eq 'modified:|new file:|deleted:'; then
...
imprimir_list listas[lFaltaCommit] "* Los siguientes repositorios estan en espera de COMMIT:"
